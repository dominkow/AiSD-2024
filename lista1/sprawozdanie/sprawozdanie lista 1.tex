...
\large{Czas wykonywania sortowania  HEAPSORT:
	dla 10000 elementów  - \(2 ms\)\\
	dla 50000 elementów - \(20 ms\)}\\

\large{Czas wykonania sortowania HEAP SORT T:
	dla 10000 elementów - \(2 ms\)\\
	dla 50000 elementów - \(14 ms\)}\\
	
\large{W przypadku algorytmu heapsort widać różnicę złożoności algorytmu po modyfikacji, a przed. Heapsort z kopcami ternarnymi jest wydajnieszy oraz szybsza dla większych zbiorów elementów. Jednakowoż w porównaniu do innych, to jest on zarówno szybszy jak i lżejszy pod względem złożoności algorytmu od insertion sort, jednakowoż jest wolniejszy od merge sorta dla dużych zbiorów danych, jak również nie dorównuje dla mergesorta po modyfikacji pod względem złożoności, to ma dosyć zbliżoną względem niemodyfikowanego merge sorta.}
